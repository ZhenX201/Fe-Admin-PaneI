...
-- Ajouter un bouton pour réduire la taille
...
-- Récupérer tous les noms dans ReplicatedStorage.Towers
local replicatedStorage = game:GetService("ReplicatedStorage")
local towers = replicatedStorage:WaitForChild("Towers"):GetChildren()

-- Créer des boutons pour chaque tour
local yOffset = 0
